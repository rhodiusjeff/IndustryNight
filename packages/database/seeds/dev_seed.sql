...
INSERT INTO users (id, phone, name, email, role, specialties, verification_status, profile_completed, source) VALUES
    ...
    ('cccccccc-cccc-cccc-cccc-cccccccccccc', '+11234567892', 'Test User 2', 'user2@example.com', 'user', ARRAY['Hair Stylist'], 'pending', true, 'posh'),
    ('dddddddd-dddd-dddd-dddd-dddddddddddd', '+11234567893', 'Test User 3', NULL, 'user', ARRAY['Makeup Artist', 'Model'], 'unverified', false, 'app');
...
INSERT INTO connections (requester_id, receiver_id, status, event_id) VALUES
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'accepted', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee');
...
INSERT INTO posts (id, author_id, content, type, like_count, comment_count) VALUES
    ('post1111-1111-1111-1111-111111111111', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Just wrapped up an amazing photoshoot! #industrynight #creative', 'general', 5, 2),
    ('post2222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Looking for a photographer for a project next week. DM me!', 'collaboration', 3, 1);

-- Add test comments
INSERT INTO post_comments (post_id, author_id, content) VALUES
    ('post1111-1111-1111-1111-111111111111', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Looks amazing!'),
    ('post1111-1111-1111-1111-111111111111', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Great work!');

-- Add test likes
INSERT INTO post_likes (post_id, user_id) VALUES
    ('post1111-1111-1111-1111-111111111111', 'cccccccc-cccc-cccc-cccc-cccccccccccc'),
    ('post1111-1111-1111-1111-111111111111', 'dddddddd-dddd-dddd-dddd-dddddddddddd');
