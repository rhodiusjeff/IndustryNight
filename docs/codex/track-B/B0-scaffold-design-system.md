...
- `docs/product/user-stories.md` — explicit user stories for the B track; defines what each actor needs to accomplish. Use this as the functional requirements source alongside the mockup.
